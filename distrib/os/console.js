...
(function (TSOS) {
    var Console = /** @class */ (function () {
        function Console(currentFont, currentFontSize, currentXPosition, currentYPosition, buffer, bufferCapt, recallIndx, oldBuffer) {
            if (currentFont === void 0) { currentFont = _DefaultFontFamily; }
            if (currentFontSize === void 0) { currentFontSize = _DefaultFontSize; }
            if (currentXPosition === void 0) { currentXPosition = 0; }
            if (currentYPosition === void 0) { currentYPosition = _DefaultFontSize; }
            if (buffer === void 0) { buffer = ""; }
            if (bufferCapt === void 0) { bufferCapt = []; }
            if (recallIndx === void 0) { recallIndx = 1; }
            if (oldBuffer === void 0) { oldBuffer = ""; }
            this.currentFont = currentFont;
            this.currentFontSize = currentFontSize;
            this.currentXPosition = currentXPosition;
            this.currentYPosition = currentYPosition;
            this.buffer = buffer;
            this.bufferCapt = bufferCapt;
            this.recallIndx = recallIndx;
        ...
        Console.prototype.historyRecall = function (chr) {
        ...
        Console.genCommands = function (a) {
        ...
        Console.prototype.matchComm = function () {
            var a = [];
            ...
            for (var i = 0; i < commands.length; i++) { //for all commands in our list check if its first two characters match a command
                var com = commands[i];
                if (startingChar == com.charAt(0)) {
                    ...
                    console.log("no match for " + startingChar + " " + com.toString());
                }
            }
        };
        return Console;
